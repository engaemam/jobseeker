    ...
    <div class="single">  
	   <div class="form-container">
        <h2>Add Ministry</h2>
                    ...
                    @endif 
        <form action="{{route('ministry.update')}}" method="post" enctype="multipart/form-data">
        {{ csrf_field() }}
        <div class="row">
            <div class="form-group col-md-12">
                <label class="col-md-3 control-lable"  for="lastName">Ministry Name</label>
                <div class="col-md-9">
                    <input type="text" name="name" value="{{$ministry->name}}" path="lastName" id="lastName" class="form-control input-sm"/>
                </div>
                @if ($errors->has('name'))
        ...
        <div class="row">
            <div class="form-group col-md-12">
                ...
                <div class="col-md-9">
                    <input type="text" name="address" value="{{$ministry->address}}" path="lastName" id="lastName" class="form-control input-sm"/>
                </div>
         ...
         <div class="row">
            <div class="form-group col-md-12">
                ...
                <div class="col-md-9 sm_1">
                   <textarea cols="77" rows="6" value="{{$ministry->details}}" name="details" required onfocus="this.value='';" onblur="if (this.value == '') {this.value = '';}"> </textarea>
        ...
        <input type="hidden" name="mid" value="{{$ministry->id}}">	
        <div class="row">
