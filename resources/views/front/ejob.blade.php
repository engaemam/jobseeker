	   ...
	   <div class="form-container">
        ...
        <div class="row">
            <div class="form-group col-md-12">
                ...
                <div class="col-md-9">
                    <input type="text" name="title" value="{{$job->requirements}}" path="lastName" id="lastName" class="form-control input-sm"/>
                </div>
                @if ($errors->has('title'))
        ...
        <div class="row">
            <div class="form-group col-md-12">
                ...
                <div class="col-md-9">
                    <input type="text" name="salary" value="{{$job->salary}}" required path="lastName" id="lastName" class="form-control input-sm"/>
                </div>
            ...
            <div class="form-group col-md-12">
                ...
                <div class="col-md-9">
                    <input type="text" name="location" value="{{$job->location}}" required path="lastName" id="lastName" class="form-control input-sm"/>
                </div>
        ...
        <div class="row">
         ...
         <div class="row">
            <div class="form-group col-md-12">
                ...
                <div class="col-md-9 sm_1">
                   <textarea cols="77" rows="6" value="{{$job->details}}" name="details" required> </textarea>
         ...
         <div class="row">
            <div class="form-group col-md-12">
                ...
                <div class="col-md-9 sm_1">
                   <textarea cols="77" rows="6" value="{{$job->requirements}}" name="requirements" required > </textarea>
